    ...
    <footer className="w-full bg-background text-foreground pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4 md:px-0">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          {/* Brands Column */}
          <div>
            <h2 className="text-xl font-bold mb-6">BRAND</h2>
            <Separator className="mb-4 bg-foreground/30 dark:bg-white/20" />
            <ul className="space-y-4">
              <li><Link href="#" className="hover:text-primary transition-colors">PRODUCT CATALOG</Link></li>
          ...
          <div>
            ...
            <Separator className="mb-4 bg-foreground/30 dark:bg-white/20" />
            <ul className="space-y-4">
              <li><Link href="#" className="hover:text-primary transition-colors">SOCIAL IMPACT</Link></li>
            </ul>
          </div>

          {/* Stores Column */}
          <div>
            <h2 className="text-xl font-bold mb-6">STORES</h2>
            <Separator className="mb-4 bg-foreground/30 dark:bg-white/20" />
            <ul className="space-y-4">
        ...
        <div className="text-xs text-gray-400 space-y-3">
          <p><Link href="#" className="underline">PRIVACY</Link> AND <Link href="#" className="underline">TERMS</Link></p>
